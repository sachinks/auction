...
urlpatterns = [
    ...
    path("jersey/save-extra/",           views.jersey_save_extra_ajax,    name="jersey_save_extra"),
    ...
    path("jersey/combined/pdf/",         views.export_combined_jersey_pdf,     name="jersey_combined_pdf"),
